...
kmin = k_res[0]
kmax = (
    1.5  # To avoid the splitting between the LoReLi spectra and Gorce model at high k
)
...
cosmoparams_LoReLi = {"H0": h * 100, "Om_0": Om_0, "OL_0": OL_0, "Ob_0": Ob_0, "s8": s8}
